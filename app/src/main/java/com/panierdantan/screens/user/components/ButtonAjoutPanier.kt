...
fun ButtonAjoutPanier(text:String, onClickAjoutPanier:()-> Unit){
    Button(
        onClick = { onClickAjoutPanier() },
        ...
        Icon(
            imageVector = Icons.ShoppingBag, // Icône utilisée (Ici, l'icône "Favorite" de Material Icons)
